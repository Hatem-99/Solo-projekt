...
Write a piece of code for programmatically removing the age property
 from the previously create object.
...
Write a piece of code for programmatically adding to the me
 object you defined before an array called skills,
...
Write a piece of code for programmatically removing the last
 skill from the skills array inside the me object.
...
Write a function called whoIsBigger which receives 
2 numbers as parameters and returns the biggest one.
*/
console.log("\n-----------------EXERCISE 2 -------------------")
...
function deleteOne(str2, boolean){
    if(boolean === true){
      let str3 = str2.slice(1);
      return str3
    }
    else{
        let str4 = str2.slice(0, str2.length - 1);
        return str4
    }
}
...
Write a function called onlyLetters which receives a string as
 a parameter and returns it removing all the digits.
...
console.log(onlyLetters("Hallo 1 world"))
/* EXERCISE 6
...
console.log(isThisAnEmail("ahsdkdhashdah@kd.com"))
/* EXERCISE 7
